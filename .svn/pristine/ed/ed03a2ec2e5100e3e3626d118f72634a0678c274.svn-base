			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<a class="btn btn-success" id="importGuestButton" data-toggle="modal" data-target="#importGuestModal"><span class="glyphicon glyphicon-plus"></span>Import Guest</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="importGuestModal" tabindex="-1" role="dialog" aria-labelledby="importGuestLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="importGuestLabel">Import Guest List</h4>
			</div>
			<div class="modal-body">
				<form id="importGuestForm">
					<div class="form-group">
						<label for="name">CSV File</label>
						<input type="file" class="form-control" id="file" placeholder="CSV File" required>
					</div>
				</form>
				<h4>CSV File format</h4>
				<img src="assets/csv_format.png">
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="submit" form="importGuestForm" class="btn btn-success">Import</button>
			</div>
		</div>
	</div>
</div>
